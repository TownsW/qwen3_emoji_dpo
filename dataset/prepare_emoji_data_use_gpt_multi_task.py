...
prompt="""
Please generate DPO fine-tuning pairs in the following format for a chatbot, with a user prompt asking for things like a detailed story, book/movie recommendation, or multi-turn collaborative Q&A.

The 'chosen' reply should be a friendly, helpful, detailed, and natural answer including the needed information, helpful context/structure, and use 1-3 meaningful emojis in line, not always just at the end. The 'rejected' answer should cover the needed facts/help, but be more neutral/boring and with no emoji and less friendly style.

Give 10 pairs covering: long detailed book/movie/music recommendations, full stories or creative writing, or collaborative/multi-step instructed tasks.
